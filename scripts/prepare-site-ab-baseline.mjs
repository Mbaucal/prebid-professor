...
import {preparePositionCacheTemplate} from '../worker/experiments/position-cache-v2.mjs';
...
writeFileSync('.generated/site-ab-baseline.mjs',
  `export const baseReadable=${JSON.stringify(base.toString())};\nexport const previousArchiveBase64=${JSON.stringify(archive.toString('base64'))};\nexport const preparedTemplates=${JSON.stringify({...preparePackageTemplates(base.toString()),positionCached:preparePositionCacheTemplate(base.toString())})};\n`);
