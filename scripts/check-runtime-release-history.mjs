...
export function verifyRuntimeReleaseProvenance(releases,readSource=readGitSource){
  for(const release of releases){
    ...
    assert(['scripts/prepare-builtin-runtime.mjs','scripts/prepare-next-runtime.mjs','scripts/prepare-creative-runtime.mjs'].includes(manifest),'Known source manifest required');
