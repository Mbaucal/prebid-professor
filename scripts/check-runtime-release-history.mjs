...
export function verifyRuntimeReleaseProvenance(releases,readSource=readGitSource){
  for(const release of releases){
    ...
    assert(['scripts/prepare-builtin-runtime.mjs','scripts/prepare-next-runtime.mjs','scripts/prepare-observed-runtime.mjs','scripts/prepare-measured-runtime.mjs','scripts/prepare-cached-runtime.mjs','scripts/prepare-variant-runtime.mjs','scripts/prepare-variant-en-runtime.mjs'].includes(manifest),'Known source manifest required');
