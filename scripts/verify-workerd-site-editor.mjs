...
try{
  ...
  check('Compiled settings GET returns all four TEST runtimes and no implicit saved selection',state.selected===null&&state.runtimes.length===4 && state.runtimes[2].version==='3.11.0-tessera.preview.1' && state.runtimes[3].version==='3.12.0-tessera.preview.1');
