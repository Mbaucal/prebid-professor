...
scripts and saved ZIPs do not upgrade automatically. This is a TEST-first release.
...
GAM report collection; those require the selected TEST package and real GAM.
