// Isolated GAM XML parser bundle: fast-xml-parser 5.11.1. MIT licenses in LICENSES.txt.
// Do not add this package to the legacy runtime lockfile: that file is part of its immutable source identity.
