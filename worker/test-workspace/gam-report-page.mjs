export function gamReportPage(plan) {
  const data=JSON.stringify({experimentId:plan.experimentId,comparison:plan.comparison,key:plan.key,values:plan.arms.map(a=>a.value)}).replace(/</g,'\\u003c');
