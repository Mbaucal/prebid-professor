import { descriptor as rawDescriptor } from '../../.generated/runtime-measured-manifest.mjs';
import { validateRuntimeDescriptor } from '../runtime/version-pin.mjs';
import { compileMeasured } from './compiler.mjs';
...
export async function buildArtifactCandidate({ snapshot, takeOver = { enabled: false }, pin, buildTimestamp, prebid = null }) {
  ...
  const generated = compileMeasured(input,runtimeDescriptor);
