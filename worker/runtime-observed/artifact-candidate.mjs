import { descriptor as rawDescriptor } from '../../.generated/runtime-observed-manifest.mjs';
import { validateRuntimeDescriptor } from '../runtime/version-pin.mjs';
import { compileObserved } from './compiler.mjs';
...
export async function buildArtifactCandidate({ snapshot, takeOver = { enabled: false }, pin, buildTimestamp, prebid = null }) {
  ...
  const generated = compileObserved(input,runtimeDescriptor);
