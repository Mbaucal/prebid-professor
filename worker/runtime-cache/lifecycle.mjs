...
export function createCacheLifecycle({win,pbjs,siteId,runtimeVersion,mode,maxAgeSeconds,contextForCode,codeForSlot,beforeRequest=()=>{},policyFactory,consentFactory,now=Date.now}) {
  ...
  const api={
    ...
    snapshot(){return {profile:'cache-runtime-candidate-v1',siteId,runtimeVersion,mode,maxAgeSeconds,stopped,trackedSlots:records.size,
